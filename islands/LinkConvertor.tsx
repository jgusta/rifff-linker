...
export default function LinkConvertor(props: {
    ...
    if (regMatch === null) {
      setOutput(
        <span class={tw`text-white`}>
          Enter an Endlesss shared rifff link or id! Or,{" "}
          <a class={tw`text-underline`} href={`${BASE_URL}/random`}>
            try a random one
          </a>
        </span>
      )
  ...
  const keyHandler: JSX.KeyboardEventHandler<HTMLInputElement> = (
  ...
  const inputHandler: JSX.GenericEventHandler<HTMLInputElement> = function (
